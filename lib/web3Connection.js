...
class Web3Connection{
	...
	closeConnection(){
		if (this.connectionType != 1){
			throw new Error("Closing connections is only required if this is a websocket connection.");
		}
	...
	*/
	...
	// Though I don't think that's very useful unless we're using websocket.
	{
		...
		objectArgs:[{
			...
			toBlock:"Number",
			address:"HexString",
			topics:"Whatever", // Array of 32 Bytes DATA topics. Topics are order-dependent. Each topic can also be an array of DATA with "or" options.
			blockhash:"HexString"
		}],
